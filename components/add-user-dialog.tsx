...
export function AddUserDialog({ open, onOpenChange, onUserAdded }: AddUserDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (data.user) {
      ...
      // Supabase Auth crea el usuario en auth.users, pero para tenerlo en nuestra tabla 'users'
      // y con los permisos, necesitaremos un trigger en la base de datos o una Server Action.
      // Por ahora, simulamos la adición a la lista local.
      const newUser = {
        id: data.user.id, // Usar el ID de Supabase Auth
        nombre: formData.nombre,
        email: formData.email,
        rol: formData.rol,
        estado: formData.estado,
